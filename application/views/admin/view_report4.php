                ...
                foreach ($zonas as $row_zona){?>
                    ...
                    <?php
                        ...
                        foreach ($ti as $row_ti){?>
                            ...
                            <?php
                                $urbanizacion_row = $this->db->get_where("urbanizacion",array("idurbanizacion" => $urbanizacion))->result();
                                
                                foreach ($urbanizacion_row as $row_u){?>
                                    <br /><blockquote>Tipo de Incidente: <?= $row_u->strnombreurbanizacion?></blockquote>
                                <?php }
                            ?>
                            <?php
                                $this->db->where("idurbanizacion = '$urbanizacion' and strestadoincidente <> 'E'");
